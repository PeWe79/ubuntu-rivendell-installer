...
#
apt -y install openssh-server patch evince telnet samba chrony emacs nfs-common smbclient net-tools traceroute gedit ntfs-3g autofs libmad0 libtwolame0 libmp3lame0
